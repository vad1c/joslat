...
using OpenAI.RealtimeApi.Dotnet.SDK.Core;
using OpenAI.RealtimeApi.Dotnet.SDK.Core.Events;
using OpenAI.RealtimeApi.Dotnet.SDK.Core.Model.Function;
using OpenAI.RealtimeApi.Dotnet.SDK.Core.Model.Response;
using OpenAI.RealtimeApi.Dotnet.SDK.Desktop;
using Timer = System.Windows.Forms.Timer;

namespace OpenAI.RealtimeApi.Dotnet.SDK.Desktop
{
